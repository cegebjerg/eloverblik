...
BEGIN
  FOR yr IN 2025..2050 LOOP
    ...
    INSERT INTO holidays (holiday_name, holiday_date, year, description) VALUES
      ...
      ('Langfredag', e - INTERVAL '2 days', yr, 'Fredagen før påske'),
      ...
      ('Pinse', e + INTERVAL '49 days', yr, 'Pånse søndag, 7. søndag efter påske'),
      ('2. pinsedag', e + INTERVAL '50 days', yr, 'Mandagen efter pinse'),
      ('Juleaften', MAKE_DATE(yr, 12, 24), yr, 'Juleaftens, fast 24 december'),
